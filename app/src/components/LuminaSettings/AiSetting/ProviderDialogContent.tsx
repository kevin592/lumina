    ...
    <div className="space-y-6">
      ...
      >
        <CardBody className="flex flex-row items-center gap-4 p-4">
          <div className="flex-shrink-0">
            <div className="w-12 h-12 rounded-lg flex items-center justify-center relative">
              ...
              <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-white rounded-full flex items-center justify-center">
                <Icon icon="ri:settings-3-line" className="w-2.5 h-2.5 text-primary" />
              </div>
            </div>
          </div>
          ...
          <Icon icon="ri:arrow-right-line" className="w-5 h-5 text-default-400" />
        </CardBody>
      </Card>
            ...
            return (
              ...
              >
                <CardBody className="flex flex-row items-center gap-3 p-4">
                  ...
                  <Icon icon="ri:arrow-right-line" className="w-4 h-4 text-default-400" />
                </CardBody>
              </Card>
            );
          })}
      ...
      <div className="flex justify-between items-center pt-6 border-t border-default-200">
        <div>
          {currentStep > 1 && (
            <Button
              variant="flat"
              startContent={<Icon icon="ri:arrow-left-line" width="16" height="16" />}
