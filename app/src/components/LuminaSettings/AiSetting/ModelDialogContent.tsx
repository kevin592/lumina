    ...
    <div className="space-y-6">
          ...
          <Button
            ...
            startContent={
              aiSettingStore.fetchProviderModels.loading.value ? (
                <Icon icon="ri:loader-4-line" width="14" height="14" className="animate-spin" />
              ) : (
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-default-500 mt-1 flex items-center">
            <Icon icon="ri:alert-line" width="12" height="12" className="inline mr-1 text-warning" />
        ...
        {editingModel.capabilities?.audio && (
          <div className="mt-2 p-3 bg-warning-50 border border-warning-200 rounded-lg">
            <p className="text-sm text-warning-700">
              <Icon icon="ri:error-warning-line" width="14" height="14" className="inline mr-2" />
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <Tooltip content="Specify the dimensions for this embedding model. Leave 0 for auto-detection.">
              <Icon icon="ri:information-line" width="14" height="14" />
            </Tooltip>
          </div>
          <Input
            type="number"
      ...
      <div className="flex justify-between gap-2 pt-6 border-t border-default-200">
        <Button
          color="primary"
          variant='light'
          startContent={<Icon icon="ri:link" width="16" height="16" />}
