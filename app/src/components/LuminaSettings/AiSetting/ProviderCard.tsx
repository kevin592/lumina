            ...
            <div className="relative">
              ...
              {provider.provider === 'custom' && (
                <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-primary rounded-full flex items-center justify-center">
                  <Icon icon="ri:settings-3-line" className="w-2 h-2 text-white" />
                </div>
              )}
            </div>
          ...
          <div className={`flex justify-between items-center`}>
            ...
            <div className={`flex gap-2 ${isMobile ? 'self-end' : ''}`}>
              <Button
                ...
                variant='light'
                color="primary"
                startContent={<Icon icon="ri:add-line" width="14" height="14" />}
                onPress={() => {
                  RootStore.Get(DialogStore).setData({
                    isOpen: true,
                    size: isMobile ? 'full' : '2xl',
            ...
            <div className="space-y-2">
              {provider.models && provider.models.length > 0 ? (
                ...
                <div className="text-center py-8 text-default-400">
                  <Icon icon="ri:file-search-line" className="w-12 h-12 mx-auto mb-2 opacity-50" />
