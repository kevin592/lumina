  ...
  return (
    ...
    >
      <div className="flex items-start space-x-4 mb-6">
        <Image src="/logo.png" alt="Lumina" className="w-16 h-16 rounded-xl" />
        <div>
          <h2 className="text-xl font-semibold">Lumina</h2>
          <div className="flex flex-col gap-2 mt-1">
            <div className="flex items-center gap-2">
              <Chip
                ...
                size="sm"
                className="text-xs"
                startContent={<Icon icon="ri:version-line" width="16" height="16" />}
              >
              ...
              {store.latestServerVersion.value != '' && store.latestServerVersion.value != store.serverVersion.value && (
                <Chip
                  ...
                  onClick={() => {
                    window.open(`https://hub.docker.com/r/Luminaspace/Lumina/tags`, '_blank')
                  }}
                >
            ...
            <div className="flex items-center gap-2">
              ...
              {store.latestClientVersion.value != '' && store.latestClientVersion.value != packageJson.version && (
                <Chip
                  ...
                  onClick={async () => {
                    if (!isDesktop()) {
                      window.open(`https://github.com/Lumina-space/Lumina/releases`, '_blank')
                    } else {
      ...
      <div className="space-y-4">
        ...
        <Item
          ...
          rightContent={
            <Link
              href="https://github.com/Lumina-space/Lumina"
              target="_blank"
        ...
        <Item
          ...
          rightContent={
            <Link
              href="https://t.me/LuminaEnglish"
              target="_blank"
              className="text-primary flex items-center gap-1"
            >
              <Icon icon="ri:telegram-fill" width="20" />
              @Lumina
            </Link>
          }
        />
        ...
        <Item
          ...
          rightContent={
            <Button
              ...
              color="warning"
              variant="flat"
              startContent={<Icon icon="ri:refresh-line" width="16" />}
