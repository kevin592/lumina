            ...
            <ModalContent className="rounded-lg">
                <ModalHeader className="flex items-center gap-2 pb-3">
                    <div className="flex items-center gap-2">
                        <Icon icon="ri-magic-line" className="text-primary" width={24} height={24} />
                ...
                <ModalBody className="py-4">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-2">
                            <Icon icon="ri:information-fill" className="text-primary" width={20} height={20} />
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            <Icon icon="ri:question-line" className="text-warning" width={20} height={20} />
                ...
                <ModalFooter className="pt-3">
                    ...
                    <Button 
                        ...
                        className="px-6" 
                        startContent={isLoading ? null : <Icon icon="ri:download-line" width={18} height={18} />}
                        isLoading={isLoading}
                        spinner={<Icon icon="ri:loader-4-line" width={24} height={24} className="animate-spin" />}
                    >
