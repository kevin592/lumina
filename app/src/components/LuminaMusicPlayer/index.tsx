...
export const LuminaMusicPlayer = observer(() => {
              ...
              >
                {metadata?.coverUrl ? (
                  ...
                  <div className="w-full h-full bg-gray-100 dark:bg-gray-200 flex items-center justify-center">
                    <Icon icon="ri:music-2-fill" className={`${isCompact ? 'w-4 h-4' : 'w-6 h-6'} text-gray-500`} />
                  </div>
                )}
              </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <button onClick={() => musicManager.togglePlay()}>
                      <Icon
                        icon={musicManager.isPlaying ? "ri:pause-fill" : "ri:play-fill"}
