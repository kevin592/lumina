...
const QuickToolPage = observer(() => {
  ...
  return (
    <div className="w-full h-full p-0 m-0 flex items-center justify-center">
      ...
      >
        <Icon icon="ri-translate-2" className="text-sm" />
      </div>
      ...
      >
        <Icon icon="ri-file-copy-line" className="text-sm" />
      </div>
      ...
      <div
        ...
        className="min-w-8 h-8 bg-none flex items-center justify-center hover:opacity-80 transition-all cursor-pointer"
      >
        <Icon icon="ri-question-answer-line" className="text-sm" />
      </div>
      ...
      <div
        ...
        className="min-w-8 h-8 bg-none flex items-center justify-center hover:opacity-80 transition-all cursor-pointer"
      >
        <Icon icon="ri-bookmark-line" className="text-sm" />
      </div>
