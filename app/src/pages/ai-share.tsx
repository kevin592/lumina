...
import { LuminaChatBox } from "@/components/LuminaAi/aiChatBox";
    ...
    useEffect(() => {
        const loadConversation = async () => {
            ...
            try {
                ...
                // Set the conversation in aiStore for LuminaChatBox to display
        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    <Icon icon="ri-loader-4-line" width="40" height="40" className="text-desc animate-spin" />
            ...
            <div className="min-h-screen bg-background flex items-center justify-center">
                <Card className="max-w-md mx-auto">
                    <CardBody className="text-center">
                        <Icon icon="ri-error-warning-line" width="48" height="48" className="text-red-500 mx-auto mb-4" />
            ...
            <div className="bg-background/80 backdrop-blur-sm sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            {
                                conversation?.account?.image ?
                                    <Avatar className="w-10 h-10" src={getluminaEndpoint(conversation?.account?.image)} />
                                    :
                                    <Icon icon="ri-loader-4-line" width="40" height="40" className="text-desc animate-spin" />
                            }
                        ...
                        <div className="text-xs text-desc">{i18n.t('powered-by-Lumina')}</div>
                    </div>
                </div>
            </div>
