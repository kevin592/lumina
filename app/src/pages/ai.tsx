...
import { AiInput } from '@/components/LuminaAi/aiInput';
    ...
    <div
      ...
      {!aiStore.isChatting ? (
        <div className="flex justify-center w-full">
          ...
          >
            {t('welcome-to-Lumina', { name: userStore.userInfo?.value?.nickName.toUpperCase() ?? userStore.userInfo?.value?.name.toUpperCase() })}!
          </motion.div>
        </div>
      ) : (
          ...
          {!aiStore.isChatting && (
            ...
            >
              <div className="flex gap-2 px-4 w-full items-center justify-center">
                ...
                <Button isIconOnly variant='light' startContent={<Icon icon="ri-more-line" className='min-w-[20px]' width="20" height="20" />} />
              </div>
            </motion.div>
          )}
        </AnimatePresence>
