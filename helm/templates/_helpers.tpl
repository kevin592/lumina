...
postgresql://{{ .Values.postgresql.auth.username }}:$(DATABASE_PASSWORD)@{{ include "lumina.fullname" . }}-postgresql:{{ .Values.postgresql.primary.service.ports.postgresql }}/{{ .Values.postgresql.auth.database }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "lumina.databaseSecretName" -}}
{{- if .Values.externalDatabase.enabled -}}
{{- if .Values.externalDatabase.existingSecret -}}
{{- .Values.externalDatabase.existingSecret -}}
{{- else -}}
{{- include "lumina.fullname" . }}-db-secret
{{- end -}}
{{- else if .Values.postgresql.enabled -}}
{{- include "lumina.fullname" . }}-postgresql
{{- end -}}
{{- end -}}
...
*/}}
{{- define "lumina.databaseSecretPasswordKey" -}}
{{- if .Values.externalDatabase.enabled -}}
{{- if .Values.externalDatabase.existingSecret -}}
