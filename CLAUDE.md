...
Lumina is an open-source, self-hosted note-taking application with AI-powered features. It's a multi-platform application (web, desktop via Tauri, mobile) built with TypeScript/React frontend and Node.js/Express backend.
...
│   └── tauri-plugin-lumina/ # Custom Tauri plugin
...
- Custom plugin in `/app/tauri-plugin-lumina/`
