...
import { searchLuminaTool } from "@server/aiServer/tools/searchLumina";
import { upsertLuminaTool } from "@server/aiServer/tools/createLumina";
import { updateLuminaTool } from "@server/aiServer/tools/updateLumina";
import { deleteLuminaTool } from "@server/aiServer/tools/deleteLumina";
...
function serverFactory() {
  ...
  // Register all Lumina tools
  createToolWithContext('searchLumina', searchLuminaTool);
  createToolWithContext('upsertLumina', upsertLuminaTool);
  createToolWithContext('updateLumina', updateLuminaTool);
  createToolWithContext('deleteLumina', deleteLuminaTool);
