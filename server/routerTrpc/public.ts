  ...
  latestClientVersion: publicProcedure
    ...
    .query(async function () {
      return await cache.wrap(
        ...
        async () => {
          // TODO: Create Lumina GitHub repository and update this URL
          // Current URL assumes repository: https://github.com/lumina-space/lumina
  ...
  latestServerVersion: publicProcedure
    ...
    .query(async function () {
      return await cache.wrap(
        ...
        async () => {
          try {
            // TODO: Create Lumina Docker Hub repository and update this URL
            // Current URL assumes repository: https://hub.docker.com/r/luminaspace/lumina
  ...
  hubSiteList: publicProcedure
    ...
    .query(async function ({ input }) {
      ...
      return await cache.wrap(
        ...
        async () => {
          try {
            // TODO: Create Lumina hub repository and update this URL
            // Current URL assumes repository: https://github.com/lumina-space/lumina-hub
