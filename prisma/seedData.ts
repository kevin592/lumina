...
export const notes = [
  {
    "id": 1,
    "type": 0,
    "content": "#Welcome\n\nWelcome to Lumina!\n\nWhether you're capturing ideas, taking meeting notes, or planning your schedule, Lumina provides an easy and efficient way to manage it all. Here, you can create, edit, and share notes anytime, anywhere, ensuring you never lose a valuable thought.",
    "isArchived": false,
    "isRecycle": false,
    "isShare": false,
    "isTop": false,
  ...
  },
  {
    "id": 6,
    "type": 0,
    "content": "https://github.com/lumina-space/lumina/",
    "isArchived": false,
    "isRecycle": false,
    "isShare": false,
    "isTop": false,
...
export async function createSeed(accountId: number) {
  try {
    ...
    if (hasNotes.length == 0) {
      ...
      ncp('prisma/seedfiles', ".lumina/files", (err) => {
        if (err) {
          console.log(err)
        }
      })
